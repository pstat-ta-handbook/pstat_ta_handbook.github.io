...
There are Union Rules (see [UAW Contract](https://ucnet.universityofcalifornia.edu/labor/bargaining-units/bx/contract.html)) which stipulate that TAs hired at 50% time may not be assigned work exceeding 220 hours per quarter (110 for 25% positions). Furthermore, no one can be asked to work for more than 40 hours in any given week or more than 8 hours in a given day. Additional rules and specific details are provided in [Article 32](https://ucnet.universityofcalifornia.edu/labor/bargaining-units/bx/docs/bx_article_32-workload_2018-2022.pdf) of the amended UAW 2865 contract. 
